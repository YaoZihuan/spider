            ...
            <div class="row">
                <div class="col-md-12">
                    <form id="spiderInfoForm" action="${pageContext.request.contextPath}/commons/spider/testSpiderInfo">
                        ...
                        <div id="advancedSetting" style="display: none;">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="id" name="id"
                                       placeholder="模板ID,系统自动填充,请勿手工赋值"
                                       value="${spiderInfo.id}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="retry" name="retry"
                                       placeholder="失败的网页重试次数"
                                       value="${spiderInfo.retry}">
                            </div>
                            <div class="form-group">
                                <label for="sleep">sleep</label>
                                <input type="number" class="form-control" id="sleep" name="sleep"
                                       placeholder="抓取每个网页睡眠时间"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="timeout" name="timeout"
                                       placeholder="HTTP链接超时时间"
                                       value="${spiderInfo.timeout}">
                            </div>
                            <div class="form-group">
                                <label for="contentReg">contentReg</label>
                                <input type="text" class="form-control" id="contentReg" name="contentReg"
                                       placeholder="正文正则表达式"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="titleXPath" name="titleXPath"
                                       placeholder="标题xpath"
                                       value="${spiderInfo.titleXPath}">
                            </div>
                            <div class="form-group">
                                <label for="categoryReg">categoryReg</label>
                                <input type="text" class="form-control" id="categoryReg" name="categoryReg"
                                       placeholder="分类信息正则"
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <c:if test="${field.need}">
                                                    <input type="checkbox" name="need${field.name}"
                                                           id="need${field.name}"
                                                           checked="checked">
                                                </c:if>
                                                <c:if test="${!field.need}">
                        ...
                        <button type="button" class="btn btn-info" id="showAdvancedSettingBtn"
